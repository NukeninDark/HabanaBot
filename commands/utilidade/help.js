...
module.exports = {
	...
	execute(message, args) {
		...
		if (!args.length) {
			...
			const Embed1 = new Discord.MessageEmbed()
				...
				.addFields(
					...
					{ name: `Para mais informações de um comando`, value: `\`${prefix}help [comando nome]\``}
				)
		...
		if(!command.description) {command.description = `Não possui descrição`}
